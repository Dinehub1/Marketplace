    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: bg }}>
      ...
      <section className="relative overflow-hidden px-6 py-20 md:py-28">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-xs font-medium mb-6" style={{ borderColor: `${accent}50`, color: primary }}>Our Services</div>
          <h1 className="heading-xl mb-6"><span style={{ color: primary }}>{brand.name} — what can it do for you?</span></h1>
      ...
      <section className="section">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-12">
            <p className="text-caption mb-3" style={{ color: primary }}>How It Works</p>
            <h2 className="heading-md mb-4" style={{ color: primary }}>Simple and Straightforward Process</h2>
          ...
          <div className="rounded-3xl p-10 md:p-16 relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${primary}, ${secondary})` }}>
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <a href={`/contact`} className="bg-white px-8 py-3.5 rounded-xl font-bold text-sm hover:translate-y-[-2px] transition-transform shadow-lg" style={{ color: primary }}>Contact Us →</a>
                <a href={`/pricing`} className="border-2 border-white/30 text-white px-8 py-3.5 rounded-xl font-bold text-sm hover:bg-white/10 transition-colors">View Pricing</a>
              </div>
            </div>
          </div>
        </div>
