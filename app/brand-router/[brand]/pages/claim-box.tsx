...
export function ClaimBox({ businessId, businessName, businessPhone, primary, secondary, accent }: Props) {
    ...
    return (
      <div className="rounded-2xl border bg-white p-6 shadow-sm" style={{ borderColor: `${accent}30` }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold" style={{ color: primary }}>Claimed & verified</h2>
            <p className="text-sm opacity-60 mt-0.5">
              {businessName} is now verified. Manage enquiries from your{" "}
              <a href="/business-dashboard" className="underline font-semibold" style={{ color: primary }}>business dashboard</a>.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="rounded-2xl border bg-white p-6 shadow-sm" style={{ borderColor: `${accent}30` }}>
      <h2 className="font-bold text-lg mb-1" style={{ color: primary }}>Own this business?</h2>
