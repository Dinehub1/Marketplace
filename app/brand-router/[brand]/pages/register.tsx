    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: bg }}>
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          {/* Left - Brand Side */}
          <div className="hidden md:block rounded-3xl p-10 text-center relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${primary}, ${secondary})` }}>
          ...
          <div>
            <div className="text-center mb-6 md:hidden">
              ...
              <h1 className="text-2xl font-bold" style={{ color: primary }}>Join {brand.name}</h1>
            ...
            <div className="rounded-2xl border bg-white p-6 md:p-8 shadow-sm" style={{ borderColor: `${accent}20` }}>
              ...
              <form className="space-y-4" action={`https://${brand.slug}.cashcard.live/login`} method="GET">
                ...
                <div>
                  ...
                  <input type="tel" required placeholder="+91 98765 43210" className="w-full rounded-xl border px-4 py-3 text-sm outline-none" style={{ borderColor: `${accent}50` }} />
                </div>
                <div>
                  <label className="block text-sm font-medium opacity-70 mb-1">Email (optional)</label>
                  <input type="email" placeholder="your@email.com" className="w-full rounded-xl border px-4 py-3 text-sm outline-none" style={{ borderColor: `${accent}50` }} />
                </div>
                <div>
                  <label className="block text-sm font-medium opacity-70 mb-1">Password</label>
                  <input type="password" required minLength={6} placeholder="Min 6 characters" className="w-full rounded-xl border px-4 py-3 text-sm outline-none" style={{ borderColor: `${accent}50` }} />
                </div>
