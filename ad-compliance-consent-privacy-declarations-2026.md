...
> Compliance statements below are summaries of vendor/platform rulebooks, not legal advice. The Google Play Families policy and Apple guideline 5.1.x both tell developers to consult counsel.
...
- **Consequence of no action** — Google's own FAQ states verbatim: *"Beginning January 16, 2024, if a partner doesn't adopt a Google-certified CMP, only **Limited Ads** will be eligible to serve on EEA and UK traffic. Enforcement will begin January 16, 2024 on a small percentage of EEA and UK traffic and will ramp up until Google enforces across all EEA and UK traffic by the end of February 2024."* — [developers.google.com/admob/android/privacy/gdpr](https://developers.google.com/admob/android/privacy/gdpr)
...
Source: [Prepare your app for review — support.google.com/googleplay/android-developer/answer/9859455](https://support.google.com/googleplay/android-developer/answer/9859455) (the same page confirms the Ads declaration must precede the Target audience and content section — see D5)
...
16. Keep every declaration **truthful and current**. Misrepresenting ad presence "may result in your app(s) being suspended"; inaccurate Data safety declarations trigger "enforcement action"; suspensions become **strikes** and multiple strikes can terminate the account **and related accounts**, and a terminated account's new signups are also terminated without refund. Sources: [App content](https://support.google.com/googleplay/android-developer/answer/9859455), [Data safety](https://support.google.com/googleplay/android-developer/answer/10787469), [DPP Enforcement](https://support.google.com/googleplay/android-developer/answer/17105854)
